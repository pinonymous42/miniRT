...
/*   Updated: 2023/04/18 19:57:23 by tasano           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_compare	get_compare(t_cylinder *cylinder, t_vec3 start, \
						t_vec3 dir, t_tval t);
t_condition	get_condition_shpere(t_sphere *sphere, t_vec3 start, t_vec3 dir);
t_condition	get_condition_cylinder(t_cylinder *cylinder, \
			t_vec3 start, t_vec3 dir);

...
/*   Updated: 2023/04/18 15:48:56 by tasano           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "get_t_val.h"

t_compare	get_compare(t_cylinder *cylinder, \
			t_vec3 start_vec, t_vec3 dir_vec, t_tval t)
{
	t_compare	compare;
	t_vec3		tmp_vec1;
	t_vec3		tmp_vec2;

	tmp_vec1 = vec3_sub(vec3_add(start_vec, vec3_mul(dir_vec, t.t1)), \
						cylinder->center);
	tmp_vec2 = vec3_sub(vec3_add(start_vec, vec3_mul(dir_vec, t.t2)), \
						cylinder->center);
